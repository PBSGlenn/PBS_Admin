...
**Recent Changes** (2026-05-01 — v0.5.0):
...
**Last Updated**: 2026-05-01
**Version**: 0.5.0 (Patient History Export — household-level export for sending to clients, vets, or other parties. Modal with audience/date/type filters and per-event selection table. DOCX via Pandoc + letterhead, optional PDF via Word COM, optional email via existing EmailDraftDialog. Notes rendered through new `htmlToMarkdown` util that strips internal audit comments.)
