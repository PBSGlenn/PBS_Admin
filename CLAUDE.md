...
**Recent Changes** (2026-04-20 — v0.4.1):
...
**Last Updated**: 2026-04-20
**Version**: 0.4.1 (Prescription Panel: custom medication option with editable Generic Name + Schedule Class; free-text custom dosage directions for tapers/PRN; formulation now combines dose concentration with form type — "5mg per tablet" + Tablet → "5mg tablet")
